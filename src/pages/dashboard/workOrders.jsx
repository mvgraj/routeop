      ...
      <div className='mt-4'>
        <table className='w-full text-sm'>
          ...
          <tbody>
            ...
            <td className='px-2 py-4'>T1029</td>
            ...
            <td className='px-2 py-4'>F1019</td>
              ...
              <td className='px-2 py-4'>9.5 L x 5.5 W x 5 H</td>
